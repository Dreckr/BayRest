library bay.rest.parameterResolution;
...
class ParameterResolutionModule extends BaseModule {

  @override
  configure() {
    bind(ParameterResolver);
    bind(HttpResolutionStrategy);
    bind(InjectorResolutionStrategy);
    bind(PathParamResolutionStrategy);
    bind(QueryParamResolutionStrategy);
    bind(HeaderParamResolutionStrategy);
    bind(FormParamResolutionStrategy);
    bind(CookieParamResolutionStrategy);
    bind(ContentBodyResolutionStrategy);
  }
}
...
class ParameterResolver {
  ...
  ParameterResolver(InjectorBindings bindings) {
    var scannedResolutionStrategies =
        bindings.withSuperType(ParameterResolutionStrategy)
          .map((binding) => binding.getInstance());

    resolutionStrategies.addAll(scannedResolutionStrategies);
  }
...
abstract class AnnotatedParamResolutionStrategy
  extends ParameterResolutionStrategy {
  ...
  Object resolveParameter(ResourceMethod resourceMethod,
    ...
    var param =
        _extractParam(resourceMethod, parameterMirror, httpRequestBody);
